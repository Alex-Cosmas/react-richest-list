import { youngest_billionaires } from '../data/youngest_billionaires'
import React, { useState } from 'react'

const YoungestBillionares = () => {
  // eslint-disable-next-line
  const [people, setPeople] = useState(youngest_billionaires)
  return (
    <>
...
export default YoungestBillionares
